...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getExceptions(){
        var roleid=JSON.parse(localStorage.getItem('userinfo')).MS_ROLE_ID
        var roleid=2
      ...
      Determine(){
        ...
        $.ajax({
          ...
          //请求的媒体类型
          //请求地址
          url : `http://www.youxinbao.com.cn:8080/CouponBalance?param={mchid:"${_this.NoForm.mchid}",month:"${_this.NoForm.month}"}`,
          //数据，json字符串
          //请求成功
