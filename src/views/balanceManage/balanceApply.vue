    ...
    <div class="filter-container">
      <el-form v-if="nowBalance" label-position="left" label-width="100px" style="width: 400px; margin-left:10px;">
        ...
        <el-form-item label="当前备付金：" prop="nowBlance">
          ...
          <!--<el-input-number v-model="nowBalance" disabled controls-position="right"/>-->
        </el-form-item>
      </el-form>
    ...
    <el-table
      ...
      <el-table-column label="备注" width="200px" align="center">
        <template slot-scope="scope">
          ...
          <el-tag>{{ scope.row.balance_memo }}</el-tag>
        </template>
      </el-table-column>
...
export default {
  ...
  created() {
    this.balance_apply = localStorage.getItem("username")
      ...
      this.$refs['dataForm'].validate((valid) => {
        ...
        if (valid) {
          ...
          if (this.tempAllData.method == 'edit') {
            ...
            this.balance_merchant_id = localStorage.getItem("userMerchantId")
          }
